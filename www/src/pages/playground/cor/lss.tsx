...
const lssSyntax: monaco.languages.IMonarchLanguage = {
...
const languageRegistrations: Record<typeof lss, LanguageRegistration> = {
  [lss]: {
    syntax: lssSyntax,
  },
};

const LssPlayground: React.FC<{}> = ({}) =>
  CorPlayground({
    experiment: lss,
    defaultPhase: "ir",
    defaultEmit: "print",
    defaultExample: "task/roc-issue-5464",
    phases: [
      "parse",
      "canonicalize",
      "solve",
