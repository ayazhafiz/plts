...
>   let var7: box<%type_7 = [ `0 { int, box<%type_7> }, `1 {} ]>
>     = @make_box(unboxed2);
>   let struct4: { int, box<%type_7 = [ `0 { int, box<%type_7> }, `1 {} ]> }
>     = @make_struct{ var6, var7 };
>   let unboxed3:
>         [ `0 { int, box<%type_7 = [ `0 { int, box<%type_7> }, `1 {} ]> }, `1 {}
>         ]
>     = @make_union<0, struct4>;
>   let var8: box<%type_7 = [ `0 { int, box<%type_7> }, `1 {} ]>
>     = @make_box(unboxed3);
>   let struct5: { int, box<%type_7 = [ `0 { int, box<%type_7> }, `1 {} ]> }
>     = @make_struct{ var5, var8 };
>   let unboxed4:
>         [ `0 { int, box<%type_7 = [ `0 { int, box<%type_7> }, `1 {} ]> }, `1 {}
>         ]
>     = @make_union<0, struct5>;
>   let var9: box<%type_7 = [ `0 { int, box<%type_7> }, `1 {} ]>
>     = @make_box(unboxed4);
>   return var9;
> }
> 
