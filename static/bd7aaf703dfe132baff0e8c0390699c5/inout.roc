...
>     [
>        `0 { str },
>        `1 { box<%type_12 = { *fn, box<erased> }> },
>        `2 { str, { *fn, box<erased> } }
>     ]>
> {
>   let captures_box4: box<{ box<%type_13 = { *fn, box<erased> }> }>
>     = @ptr_cast(captures_5 as box<{ box<%type_13 = { *fn, box<erased> }> }>);
>   let captures_stack4: { box<%type_13 = { *fn, box<erased> }> }
>     = @get_boxed<captures_box4>;
>   let toNext: box<%type_13 = { *fn, box<erased> }>
>     = @get_struct_field<captures_stack4, 0>;
>   let inner1: { *fn, box<erased> } = @get_boxed<toNext>;
>   let fnptr3: *fn = @get_struct_field<inner1, 0>;
>   let captures3: box<erased> = @get_struct_field<inner1, 1>;
>   let var5:
>         box<
>           %type_19 =
>           [
...
>        `0 { str },
>        `1 { { *fn, box<erased> } },
>        `2 { str, box<%type_17 = { *fn, box<erased> }> }
>     ]>
> {
>   let captures_box8: box<{ box<%type_16 = { *fn, box<erased> }> }>
>     = @ptr_cast(captures_10 as box<{ box<%type_16 = { *fn, box<erased> }> }>);
>   let captures_stack8: { box<%type_16 = { *fn, box<erased> }> }
>     = @get_boxed<captures_box8>;
>   let toNext1: box<%type_16 = { *fn, box<erased> }>
...
>         ]
>     = @get_boxed<op1>;
>   let discr: int = @get_union_id<inner3>;
>   switch discr {
>   0 -> {
>     let payload2: { str } = @get_union_struct<inner3>;
>     let x2: str = @get_struct_field<payload2, 0>;
>     x2
>   }
>   1 -> {
>     let payload: { { *fn, box<erased> } } = @get_union_struct<inner3>;
...
>   }
>   2 -> {
>     let payload1: { str, { *fn, box<erased> } } = @get_union_struct<inner3>;
...
> {
>   let captures_box2:
>         box<{ box<%type_11 = { *fn, box<erased> }>, { *fn, box<erased> } }>
>     = @ptr_cast(
>         captures_2 as
>         box<{ box<%type_11 = { *fn, box<erased> }>, { *fn, box<erased> } }>);
>   let captures_stack2:
>         { box<%type_11 = { *fn, box<erased> }>, { *fn, box<erased> } }
>     = @get_boxed<captures_box2>;
>   let continue: box<%type_11 = { *fn, box<erased> }>
>     = @get_struct_field<captures_stack2, 0>;
...
>    toNext: box<%type_14 = { *fn, box<erased> }>):
>   box<
>     %type_7 =
>     [ `0 { str }, `1 { { *fn, box<erased> } }, `2 { str, { *fn, box<erased> } }
>     ]>
...
>   let captures_stack_6: { box<%type_14 = { *fn, box<erased> }> }
>     = @make_struct{ toNext };
>   let captures_box_6: box<{ box<%type_14 = { *fn, box<erased> }> }>
...
>    toNext1: box<%type_16 = { *fn, box<erased> }>):
>   box<
>     %type_20 =
>     [
>        `0 { str },
...
>   let captures_stack_7: { box<%type_16 = { *fn, box<erased> }> }
>     = @make_struct{ toNext1 };
>   let captures_box_7: box<{ box<%type_16 = { *fn, box<erased> }> }>
...
>   let unboxed1: { *fn, box<erased> } = @make_struct{ fn_ptr_7, captures_18 };
>   let var9: box<%type_17 = { *fn, box<erased> }> = @make_box(unboxed1);
>   let struct1: { str, box<%type_17 = { *fn, box<erased> }> }
>     = @make_struct{ s1, var9 };
>   let unboxed2:
>         [
>            `0 { str },
...
>    continue: box<%type_11 = { *fn, box<erased> }>):
>   box<
>     %type_10 =
>     [ `0 { str }, `1 { { *fn, box<erased> } }, `2 { str, { *fn, box<erased> } }
>     ]>
