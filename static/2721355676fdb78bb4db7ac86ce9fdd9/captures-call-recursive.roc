...
> fn g2(t: [F, T], captures3: {x: Int}): Int =
>   let x: Int = captures3.x in
>   when t is
>     | T -> ~add x 1
>     | F -> when G1 {x: x} is
>              | G1 captures2 -> g2(T, captures2)
>            end
>   end
...
>          | F1 -> f2(2)
>        end is
>     | G1 captures1 -> g2(F, captures1)
>   end

> cor-out +ir -print
> fn g2(t: [ `0 {}, `1 {} ], captures3: { int }): int
> {
...
>   let var5: [ `0 { { int } } ] = @make_union<0, struct2>;
>   return var5;
> }
> 
> fn main_thunk(): int
...
>   let discr2: int = @get_union_id<var6>;
>   switch discr2 {
>   0 -> {
>     let var7: int = 2;
>     @call_direct(f2, var7)
...
>     let var8: [ `0 {}, `1 {} ] = @make_union<0, struct4>;
