...
> let %4 : [ `0 [ `0, `1, `2 ], `1 [ `0, `1 ], `2 [ `0, `1, `2 ] ] = @build_tag 2 %3;
...
>             let %23 : {} = @build_struct;
>             let %24 : [ `0 ] = @build_tag 0 %23;
>             let %25 : { [ `0 ] } = @build_struct %24;
>             let %26 : [ `0 [ `0 ], `1 [ `0 ], `2 [ `0, `1 ], `3, `4 [ `0 ] ] = @build_tag 0 %25;
>             feed %26
>           }
>           1: {
...
>             let %34 : {} = @build_struct;
>             let %35 : [ `0 ] = @build_tag 0 %34;
>             let %36 : { [ `0 ] } = @build_struct %35;
>             let %37 : [ `0 [ `0 ], `1 [ `0 ], `2 [ `0, `1 ], `3, `4 [ `0 ] ] = @build_tag 1 %36;
>             feed %37
>           }
>           2: {
>             let %38 : { [ `0, `1, `2 ] } = @get_union_struct x;
>             let %16 : [ `0, `1, `2 ] = @get_field 0 %38;
>             let %39 : int = @get_tag_id %16;
>             switch %39 {
>               0: {
>                 let %41 : {} = @get_union_struct %16;
>                 let %42 : {} = @build_struct;
>                 let %43 : [ `0, `1 ] = @build_tag 0 %42;
>                 let %44 : { [ `0, `1 ] } = @build_struct %43;
>                 let %45 : [ `0 [ `0 ], `1 [ `0 ], `2 [ `0, `1 ], `3, `4 [ `0 ] ] = @build_tag 2 %44;
>                 feed %45
>               }
>               2: {
>                 let %47 : {} = @get_union_struct %16;
>                 let %48 : {} = @build_struct;
>                 let %49 : [ `0, `1 ] = @build_tag 1 %48;
>                 let %50 : { [ `0, `1 ] } = @build_struct %49;
>                 let %51 : [ `0 [ `0 ], `1 [ `0 ], `2 [ `0, `1 ], `3, `4 [ `0 ] ] = @build_tag 2 %50;
>                 feed %51
>               }
...
>         let %53 : {} = @build_struct;
>         let %54 : [ `0 ] = @build_tag 0 %53;
>         let %55 : { [ `0 ] } = @build_struct %54;
>         let %56 : [ `0 [ `0 ], `1 [ `0 ], `2 [ `0, `1 ], `3, `4 [ `0 ] ] = @build_tag 4 %55;
>         feed %56
>       }
>       2: {
>         let %57 : {} = @get_union_struct %5;
>         let %58 : {} = @build_struct;
>         let %59 : [ `0 [ `0 ], `1 [ `0 ], `2 [ `0, `1 ], `3, `4 [ `0 ] ] = @build_tag 3 %58;
>         feed %59
>       }
...
>         let %74 : {} = @build_struct;
>         let %75 : [ `0 ] = @build_tag 0 %74;
>         let %76 : { [ `0 ] } = @build_struct %75;
>         let %77 : [ `0 [ `0 ], `1 [ `0 ], `2 [ `0, `1 ], `3, `4 [ `0 ] ] = @build_tag 0 %76;
>         feed %77
>       }
>       1: {
...
>         let %85 : {} = @build_struct;
>         let %86 : [ `0 ] = @build_tag 0 %85;
>         let %87 : { [ `0 ] } = @build_struct %86;
>         let %88 : [ `0 [ `0 ], `1 [ `0 ], `2 [ `0, `1 ], `3, `4 [ `0 ] ] = @build_tag 1 %87;
>         feed %88
>       }
>       2: {
>         let %89 : { [ `0, `1, `2 ] } = @get_union_struct x;
>         let %67 : [ `0, `1, `2 ] = @get_field 0 %89;
>         let %90 : int = @get_tag_id %67;
>         switch %90 {
>           0: {
>             let %92 : {} = @get_union_struct %67;
>             let %93 : {} = @build_struct;
>             let %94 : [ `0, `1 ] = @build_tag 0 %93;
>             let %95 : { [ `0, `1 ] } = @build_struct %94;
>             let %96 : [ `0 [ `0 ], `1 [ `0 ], `2 [ `0, `1 ], `3, `4 [ `0 ] ] = @build_tag 2 %95;
>             feed %96
>           }
>           2: {
>             let %98 : {} = @get_union_struct %67;
>             let %99 : {} = @build_struct;
>             let %100 : [ `0, `1 ] = @build_tag 1 %99;
>             let %101 : { [ `0, `1 ] } = @build_struct %100;
>             let %102 : [ `0 [ `0 ], `1 [ `0 ], `2 [ `0, `1 ], `3, `4 [ `0 ] ] = @build_tag 2 %101;
>             feed %102
>           }
...
>     let %104 : int = @get_tag_id %7;
>     switch %104 {
>       0: {
>         let %106 : {} = @get_union_struct %7;
>         let %110 : int = @get_tag_id x;
>         switch %110 {
>           0: {
...
>             let %117 : [ `0 ] = @build_tag 0 %116;
>             let %118 : { [ `0 ] } = @build_struct %117;
>             let %119 : [ `0 [ `0 ], `1 [ `0 ], `2 [ `0, `1 ], `3, `4 [ `0 ] ] = @build_tag 0 %118;
>             feed %119
>           }
>           1: {
...
>             let %157 : [ `0 ] = @build_tag 0 %156;
>             let %158 : { [ `0 ] } = @build_struct %157;
>             let %159 : [ `0 [ `0 ], `1 [ `0 ], `2 [ `0, `1 ], `3, `4 [ `0 ] ] = @build_tag 0 %158;
>             feed %159
>           }
>           1: {
